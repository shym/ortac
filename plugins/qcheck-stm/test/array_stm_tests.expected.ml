...
module Spec = struct
  ...
  type nonrec state = { size : int; contents : char list }

  let init_state =
    let i_4 = 16 and a_5 = 'a' in
    {
      size = i_4;
      contents =
    ...
    make ~print:show_cmd
      ...
      oneof
        [
          ...
          pure (fun i_2 j_1 a_2 -> Fill (i_2, j_1, a_2))
          <*> int
          <*> int
          <*> char;
          pure To_list;
    ...
    | Set (i_1, a_1) ->
        if
          ...
          let __t2__004_ =
            Ortac_runtime.Gospelstdlib.( < )
              (Ortac_runtime.Gospelstdlib.integer_of_int i_1)
              (Ortac_runtime.Gospelstdlib.integer_of_int state__002_.size)
          in
        ...
        then
          {
            ...
            contents =
              Ortac_runtime.Gospelstdlib.List.mapi
                (fun j x ->
                  if j = Ortac_runtime.Gospelstdlib.integer_of_int i_1 then a_1
                  else x)
                state__002_.contents;
          }
        else state__002_
    | Fill (i_2, j_1, a_2) ->
        if
  ...
  let postcond cmd__007_ state__008_ res__009_ =
    ...
    | Length, Res ((Int, _), i_3) -> i_3 = (Lazy.force new_state__010_).size
    | Get i, Res ((Result (Char, Exn), _), a_4) -> (
        if
          ...
          let __t2__012_ =
            Ortac_runtime.Gospelstdlib.( < )
              (Ortac_runtime.Gospelstdlib.integer_of_int i)
              (Ortac_runtime.Gospelstdlib.integer_of_int state__008_.size)
          in
        ...
        then
          ...
          | Ok a_4 ->
              ...
              = Ortac_runtime.Gospelstdlib.List.nth
                  ...
                  (Ortac_runtime.Gospelstdlib.integer_of_int i)
          | _ -> false
        else match a_4 with Error (Invalid_argument _) -> true | _ -> false)
    | Set (i_1, a_1), Res ((Result (Unit, Exn), _), res) -> (
        ...
        else match res with Error (Invalid_argument _) -> true | _ -> false)
  ...
  let run cmd__017_ sut__018_ =
    ...
    | Get i -> Res (result char exn, protect (fun () -> get sut__018_ i) ())
    | Set (i_1, a_1) ->
        Res (result unit exn, protect (fun () -> set sut__018_ i_1 a_1) ())
    | Fill (i_2, j_1, a_2) ->
        Res (result unit exn, protect (fun () -> fill sut__018_ i_2 j_1 a_2) ())
